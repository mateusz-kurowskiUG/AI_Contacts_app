...
const ChatForm = () => {
	...
	return (
		<div className="w-full max-w-2xl mx-auto p-4 absolute bottom-2">
			<Form {...chatForm}>
							...
							<FormItem>
								<div className="relative">
									<FormControl>
										<Textarea
											{...field}
											className="min-h-[60px] resize-none pr-12 py-4 text-base border-2 focus:border-primary/50 transition-colors"
